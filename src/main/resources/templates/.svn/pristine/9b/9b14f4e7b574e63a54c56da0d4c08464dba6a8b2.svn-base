...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <div class="layui-inline" style="float:right">
            <a class="layui-btn layui-btn-normal" data-type="addUser">房源验真</a>
            <a class="layui-btn layui-btn-normal" data-type="coverPic">替换图片</a>
        </div>
    </form>
    </div>
</fieldset>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/ershoufang/list',
            method:'post',
            ...
            cols: [[
                ...
                {field:'picUrl',    title: '图片', templet:'#showPhoto'}, 
                ...
                {field:'verifyStatus',	title: '验真'},
                {field:'online',	title: '上架'},
                {field:'agent_tel',	title: '经纪人号码'},
                {field:'agent_name',	title: '经纪人'},
        ...
        var active={
            addUser : function(){
				...
				layer.confirm('是否开始房源验证-绑定标准小区',  function(index, layero){
					$.post("${base}/admin/ershoufang/synchred", null ,function (res){
                        if(res.success){
            ...
            coverPic : function(){
				layer.confirm('是否开始替换封面图片',  function(index, layero){
					$.post("${base}/admin/ershoufang/coverPic", null ,function (res){
                        if(res.success){
                            layer.msg("正在同步，几分钟后刷新结果",{time: 1000},function(){
                                table.reload('test', t);
                            });
