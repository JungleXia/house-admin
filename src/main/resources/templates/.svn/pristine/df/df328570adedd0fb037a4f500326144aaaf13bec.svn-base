...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <div class="layui-inline">
            <input type="text" value="" name="s_title" placeholder="请输入接口标题" class="layui-input search_input">
        </div>
        <div class="layui-inline">
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/user/accessLog/query',
            method:'post',
            ...
            cols: [[
                {type:'checkbox'},
                {field:'clientIp',    title: 'IP'},
                {field:'client',    title: '客户端'},
                {field:'clientKey',    title: 'MAC'},
                {field:'browser',    title: '手机型号'},
                {field:'title',    title: '接口'},
                {field:'reqUri',    title: '请求'},
                {field:'reqParams',    title: '参数'},
                {field:'response',    title: '响应'},
                {field:'processTime',    title: '响应时间（毫秒）'},
