...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="houseStatus">
        {{#  if(d.status == 1){ }}
    ...
    <script type="text/html" id="standRegion">
        <!-- 这里的 checked 的状态只是演示 -->
        <span class="layui-badge layui-bg-green">{{d.standRegion.district}}</span>
        <span class="layui-badge layui-bg-gray">{{d.standRegion.blockName}}</span>
    </script>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/fang/region/standard/list',
            method:'post',
            ...
            cols: [[
                {field:'id',		title: 'ID'},
                {field:'privinceInitials',    	title: '省首字母'},
                {field:'province',     title: '省'},
                {field:'provinceCode',    title: '省代码'},
                {field:'cityInitials',	title: '市首字母'},
                {field:'city',    title: '市'},
                {field:'cityCode',    	title: '市代码'},
                {field:'districtInitials',	title: '区首字母'},
                {field:'districtNo',	title: '编号'},
                {field:'district',	title: '大区域'},
                {field:'districtPinyin',	title: '拼音'},
                {field:'blockInitials',	title: '子区首字母'},
                {field:'blockName',	title: '子区域'},
                {field:'blockPinyin',	title: '拼音'},
