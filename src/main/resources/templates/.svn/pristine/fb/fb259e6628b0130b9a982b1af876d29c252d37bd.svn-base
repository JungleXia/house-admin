...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        <div class="layui-inline">
            <input type="text" value="" name="s_type" placeholder="请输入" class="layui-input search_input">
        </div>
        <div class="layui-inline">
            <input type="text" value="" name="s_label" placeholder="请输入" class="layui-input search_input">
        </div>
        <div class="layui-inline">
...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="standRegion">
        <!-- 这里的 checked 的状态只是演示 -->
        <span class="layui-badge layui-bg-green">{{d.regions.city}}</span>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/xinfang/loupan/list',
            method:'post',
            ...
            cols: [[
                {type:'checkbox'},
                {field:'projectName',     title: '楼盘'},
                {field:'aliasName',    	title: '别名'},
                {field:'url',    title: '原链接', templet:'#showUrl'},
                {field:'region',    	title: '区域', templet: 'standRegion'},
                {field:'address',    title: '地址'},
                {field:'resPhone',    	title: '售楼电话'},
                {field:'longlat',	title: '经纬度'},
                {field:'useType',	title: '用途'},
                {field:'developers',	title: '开发商'},
                {field:'propertyCompany',	title: '物业公司'},
                {field:'buildType',	title: '建筑类型'},
                {field:'propertyYear',	title: '产权年限'},
                {field:'license',	title: '许可证'},
                {field:'saleStatus',	title: '在售'},
