...
<fieldset class="layui-elem-field">
    <legend>中介小区检索</legend>
    <div class="layui-field-box">
    <form class="layui-form">
        <div class="layui-inline">
            <input type="text" value="" name="s_community" placeholder="请输入小区名" class="layui-input search_input">
        </div>
        <div class="layui-inline">
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'url',     title: '原网站', templet:"#showUrl"},
                {field:'regions',    title: '区域', templet:'#standRegion'},
                {field:'buildYear',    title: '建筑年'},
