...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/user/account/list',
            method:'post',
            ...
            cols: [[
                ...
                {field:'csite',    title: '来源'},
                {field:'idfa',    title: 'IDFA'},
                {field:'imei',    title: 'IMEI'},
                {field:'downPayment',    title: '首付'},
                {field:'downRatio',    title: '首付比'},
                {field:'buylimit',    title: '限购'},
                {field:'location',    title: '定位'},
                {field:'officeAddress',    title: '工作地点'},
                {field:'schoolName',    title: '学位'},
                {field:'xinOresf',    title: '新房Or二手'},
                {field:'huxing',    title: '户型'},
                {field:'useType',    title: '用途'},
                {field:'city',    title: '归属地'},
                {field:'lastLogin',  title: '最后登录',width:'10%',templet:'<div>{{ layui.laytpl.toDateString(d.lastLogin) }}</div>',unresize: true}, //单元格内容水平居中
            ]]
        };
        table.render(t);
