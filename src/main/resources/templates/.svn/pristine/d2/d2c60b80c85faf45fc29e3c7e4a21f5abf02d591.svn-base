...
<head>
    <meta charset="utf-8">
    <title>APP用户浏览记录--${site.name}</title>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/user/view/list?s_clientKey=${clientKey}',
            method:'post',
            ...
            cols: [[
                ...
                {field:'createTime',  title: '浏览时间',width:'10%',templet:'<div>{{ layui.laytpl.toDateString(d.createTime) }}</div>',unresize: true}, //单元格内容水平居中
            ]]
        };
        table.render(t);
