...
<form class="layui-form">
    <div class="user_left">
        ...
        <label class="layui-form-label">广告图类型</label>
	        <div class="layui-input-block">
	            <select name="type" class="layui-input">
	                <option value="11">网站首页</option>
	                <option value="22">移动端首页</option>
	            </select>
	        </div>
    	</div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="no" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
	        <label class="layui-form-label">是否上架</label>
	        <div class="layui-input-block">
	            <input type="checkbox" name="expired" lay-skin="switch"  lay-text="上架|下架" checked="" >
	        </div>
	    </div>
    </div>
    <div class="user_right">
        ...
        <img src="${base}/static/images/face.jpg" style="margin-top:50px;" id="imageUrl">
...
<script>
    ...
    layui.use(['form','jquery','layer','upload','laydate'],function() {
        ...
        form.on("submit(changeAdvert)",function (data) {
            ...
            $.post("${base}/admin/advert/add",data.field,function(res){
