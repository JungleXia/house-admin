...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/community/stand/list',
            method:'post',
            ...
            cols: [[
                {type:'checkbox'},
                {field:'standId',     title: 'Id'},
                {field:'standName',     title: '标准小区'},
                {field:'city',     title: '城市'},
                {field:'useType',     title: '用途'},
                {field:'region',     title: '区域'},
                {field:'regionSub',    title: '子区域'},
                {field:'updateTime',    title: '更新时间'},
                {field:'status',    title: '是否参与分析', templet:'#userStatus'},
            ]]
        };
        table.render(t);
