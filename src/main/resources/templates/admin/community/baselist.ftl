...
<fieldset class="layui-elem-field">
    <legend>基础小区检索</legend>
    <div class="layui-field-box">
    <form class="layui-form">
        <div class="layui-inline">
            <input type="text" value="" name="s_city" placeholder="请输城市" class="layui-input search_input">
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            <a class="layui-btn layui-btn-normal" data-type="addUser">挂牌分析</a>
        </div>
    </form>
    </div>
</fieldset>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/community/base/list',
            method:'post',
            ...
            cols: [[
                {type:'checkbox'},
                {field:'baseId',     title: 'BaseId'},
                {field:'city',     title: '城市'},
                {field:'baseName',     title: '基础小区'},
                {field:'longlat',     title: '坐标'},
                {field:'aliasName',     title: '别名'},
                {field:'versionDate',     title:'创建日期'},
            ]]
        };
        table.render(t);
