...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        <div class="layui-inline">
            <input type="text" value="" name="s_houseCode" placeholder="请输入房源编码" class="layui-input search_input">
        </div>
        <div class="layui-inline">
            <input type="text" value="" name="s_standId" placeholder="请输入标准小区ID" class="layui-input search_input">
        </div>
        <div class="layui-inline">
            <input type="text" value="" name="s_standName" placeholder="请输入标准小区名称" class="layui-input search_input">
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            <a class="layui-btn layui-btn-normal" data-type="addUser">绑定标准小区</a>
        </div>
    </form>
    </div>
</fieldset>
<div class="layui-form users_list">
    ...
    <script type="text/html" id="showPhoto">
    	{{#  if(d.picHuxing != null){ }}
		<img src="{{d.picHuxing}}" width='50' height='50' onclick="layerPhoto('{{d.picHuxing}}', '')">
		{{#  } }}
    </script>
</div>
<div id="page"></div>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                {type:'checkbox'},
                {field:'houseCode',    title: '房源编码'},
                {field:'projectName',    title: '项目'},
                {field:'useType',    	title: '实际用途'},
                {field:'targetType',    	title: '显示用途'},
                {field:'area',    	title: '面积'},
                {field:'intentPrice',		title: '意向价格'},
                {field:'region',	title: '区域'},
                {field:'codeStatus',	title: '有效状态'},
                {field:'verifyStatus',	title: '是否认证'},
                {field:'standId',	title: '标准小区Id'},
                {field:'standName',	title: '标准小区'},
                {field:'baseId',	title: '基础小区Id'},
                {field:'baseName',	title: '基础小区'},
        ...
        var active={
            addUser : function(){
				layer.confirm('是否同步',  function(index, layero){
					$.post("${base}/admin/houseCode/synchred", null ,function (res){
                        if(res.success){
