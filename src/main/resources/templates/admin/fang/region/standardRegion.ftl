    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'privincePinyin',    	title: '拼音'},
                {field:'privinceInitials',    	title: '首字母'},
                {field:'city',    title: '市'},
                {field:'cityCode',    	title: '市代码'},
                {field:'cityPinyin',		title: '市拼音'},
                {field:'cityInitials',	title: '市首字母'},
                {field:'district',	title: '大区域'},
                {field:'districtNo',	title: '编号'},
                {field:'districtPinyin',	title: '拼音'},
                {field:'districtInitials',	title: '首字母'},
                {field:'blockName',	title: '子区域'},
                {field:'blockPinyin',	title: '拼音'},
                {field:'blockInitials',	title: '首字母'},
                {field:'md5Region',	title: 'MD5'},
                {field:'status',	title: '状态', templet:'#houseStatus'},    
