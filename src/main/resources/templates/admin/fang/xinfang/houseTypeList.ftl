...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="showPhoto">
    	{{#  if(d.picUrl != null){ }}
		<img src="{{d.picHuxing}}" width='50' height='50' onclick="layerPhoto('{{d.picUrl}}', '')" >
		{{#  } }}
    </script>
</div>
<div id="page"></div>
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'picUrl',    title: '查看图片', templet:'#showPhoto'},
                {field:'totalPrice',    	title: '总价（万）'},
                {field:'unitPrice',    	title: '单价'},
                {field:'projectName',    	title: '小区'},
                {field:'projectId',    	title: '标准小区Id'},
