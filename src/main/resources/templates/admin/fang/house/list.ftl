...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <div class="layui-inline">
            <input type="text" value="" name="s_standName" placeholder="请输入标准小区" class="layui-input search_input">
        </div>
        <div class="layui-inline">
            <input type="text" value="" name="s_baseId" placeholder="请输入基础小区ID" class="layui-input search_input">
        </div>
        <div class="layui-inline">
            <input type="text" value="" name="s_baseName" placeholder="请输入基础小区" class="layui-input search_input">
        </div>
        <div class="layui-inline">
			<select name="s_online" lay-search class="layui-select " lay-search>
        ...
        <div class="layui-inline " style="float:right">
            <a class="layui-btn layui-btn-normal" data-type="addUser">同步真房源</a>
            <a class="layui-btn layui-btn-normal" data-type="detection">异常值检测</a>
            <a class="layui-btn layui-btn-normal" data-type="guapai">挂牌分析</a>
            <a class="layui-btn layui-btn-normal" data-type="houseAnalysis">房源分析</a>
        </div>
    </form>
    </div>
</fieldset>
