...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="showUrl">
    	{{#  if(d.url != null && d.url != ''){ }}
        	<a class="layui-badge layui-bg-green" target="_blank" href="{{d.url}}">查看房源</a>
         {{#  } }}
    </script>
    <script type="text/html" id="download">
       	<a class="layui-badge layui-bg-green" target="_blank" href="https://console.huaweicloud.com/privatenumber/?agencyId=05bd62b2bc8025551fd0c00a829fe67a&region=cn-north-1&locale=zh-cn#/management/businessdetail">下载录音</a>
    </script>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/user/privateNumber/query',
            method:'post',
            ...
            cols: [[
                ...
                {field:'relationNum',    title: '加密电话'},
                {field:'subscriptionId',    title: '订单id'},
                {field:'resultdesc',    title: '绑定'},
                {field:'createTime',    title: '绑定时间'},
                {field:'expiredTime',    title: '过期时间'},
                {field:'expired',    title: '是否过期'},
                {field:'houseId',    title: 'houseId'},
                {field:'url',    title: '房源链接', templet: '#showUrl'},
            ]]
        };
        table.render(t);
