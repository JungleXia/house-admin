...
import com.mysiteforme.admin.redis.RedisExtManager;
...
public class ShiroConfig {
    ...
    public CookieRememberMeManager rememberMeManager(){
        ...
        rememberMeManager.setCipherKey(Base64.decode("ZFHVhdsgUs0FSA3SDFAdag=="));
    ...
    public RedisManager redisManager(){
    	RedisExtManager manager = new RedisExtManager();
