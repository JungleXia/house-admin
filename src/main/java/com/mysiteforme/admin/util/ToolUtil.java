...
public class ToolUtil {
	...
	public static Map<String,String> getAddressByIP(String ip) {
		...
		finalMap.put("city","");
		try {
			StringBuilder sb = new StringBuilder("https://ip.taobao.com/outGetIpInfo?ip=");
			sb.append(ip);
			sb.append("&accessKey=alibaba-inc");
	...
	public static Map<String,String> getAddressByTelPhone(String telPhone) {
		Map finalMap = Maps.newHashMap();
		finalMap.put("province", "");
		finalMap.put("city", "");
		try {
			StringBuilder sb = new StringBuilder("http://apis.juhe.cn/mobile/get?phone=");
			sb.append(telPhone);
			sb.append("&dtype=f4f5658fd66482931b7350b3d33b401d&key=f4f5658fd66482931b7350b3d33b401d");
			LOGGER.info(sb.toString());
			String result= HttpUtil.get(sb.toString(), "UTF-8");
			Map resultMap = JSON.parseObject(result,Map.class);
			LOGGER.info(resultMap.toString());
			Integer code = Integer.valueOf(resultMap.get("resultcode").toString());
			if (code == 200) {
				Map<String,String> detail = (Map<String,String>)resultMap.get("result");
				finalMap.put("province", detail.get("province"));
				finalMap.put("city", detail.get("city"));
			}
		} catch (Exception e) {
			LOGGER.debug(e.getMessage());
		}
	...
	public static void main(String args[]) throws Exception {
		...
		StringBuilder sb = new StringBuilder("https://ip.taobao.com/outGetIpInfo?ip=117.82.105.93&accessKey=alibaba-inc");
		String result= HttpUtil.get(sb.toString(), "UTF-8");
		System.out.println(result);
		Map<String,String> map = Maps.newHashMap();
		Map resultMap = ToolUtil.getAddressByIP("117.82.105.93");
