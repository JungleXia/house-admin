...
public class Constants {
	...
	public static final String DATA_FROM_QF = "Q房网";
	
	public static final String DATA_FROM_LIANJIA = "链家";
	
	public static final String DATA_FROM_ZY = "中原";
	
	public static final String DATA_FROM_LYJ = "乐有家";
}
