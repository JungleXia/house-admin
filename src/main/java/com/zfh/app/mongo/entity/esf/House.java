...
/**
 * 综合房源，包括新房和二手房，用于数据列表展示
 * 
 * @author CB
 * 
 * @dateTime 2019年5月6日下午4:35:02
 */
@Document(collection = "esf_house")
//@CompoundIndexes({
//	// name：索引名称 def：字段(1正序 -1倒序) unique：是否唯一索引
//	// 直接加到字段上面没用
//	@CompoundIndex(def = "{room:1, reco:1, online:1}", background = true),
//	@CompoundIndex(def = "{standId:1, room:1, online:1}", background = true),
//	@CompoundIndex(def = "{standId:1, status:1, online:1}", background = true),
//	@CompoundIndex(def = "{geometry:'2dsphere', room:1, reco:1, online:1, totalPrice:1}", background = true)
//})
public class House implements Serializable{

	private static final long serialVersionUID = -8125860870735654906L;
