...
public interface IAXBInterfaceDemo {
     ...
     * @param calleeNum      被叫号码
     */
	String axbModifyNumber(String subscriptionId, String callerNum, String calleeNum);
     ...
     */
	String axbUnbindNumber(String subscriptionId, String relationNum);
     ...
     * @param relationNum    关系号码 都传时以subscriptionId优先
     */
	String axbQueryBindRelation(String subscriptionId, String relationNum);
     ...
     */
	String axbStopCall(String sessionid);
}